...
class Album extends Component {
    ...
    render() {
        ...
        const arr1 = this.state.result.filter((photo,i)=>{return photo.category==="sesamestreet"})
        const arr2 = this.state.result.filter((photo,i)=>{return photo.category==="gumball"})
        const arr3 = this.state.result.filter((photo,i)=>{return photo.category==="other"})
        const arr4 = this.state.result.filter((photo,i)=>{return photo.category==="pokemon"})
        return (
            <ScrollView>
                <FlatList
                    horizontal
