...
const PaymentScreen = () => {
    ...
    const onCheckStatus = async (paymentResponse) => {
      ...
      // perform operation to check payment status
        ...
        var raw = JSON.stringify({"username":"test3","amount":"368"});
        ...
        fetch("http://localhost:8000/donate/", requestOptions)
...
container: { flex: 1, paddingTop: 100, backgroundColor: 'red', justifyContent: 'center'},
navigation: { flex: 2 },
