...
// This renders categories of art type content
  ...
  const [list, setList] = useState([
    {
      ...
      key: "a1",
      item: "Coloring",
      pic: { uri: "https://imgur.com/0r8qpuJ.png" },
    },
    {
      nav: "Drawing",
      key: "a2",
      item: "Drawing",
      pic: { uri: "https://imgur.com/Hsm0YR5.png" },
    },
  ]);
              ...
              <TouchableOpacity onPress={() => pressHandler(x.nav)} key={i}>
                <View style={styles[y]}>
                  <View style={styles.cardContent}>
                    <Image source={x.pic} style={{ width: 200, height: 180 }} />
